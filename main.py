...
btn5 = tk.Button(window, text='Exit', height=90, width=200, fg='red', command=window.destroy, image=btn5_image, compound='left')
btn5['font'] = btn_font
...
btn8 = tk.Button(window, text="remote", height=90, width=200, fg="violet",command=tele_intit, compound='left', image=btn8_image)
btn8['font'] = btn_font
